...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "ZamMusicAssistant")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "Virtual✨")
PROJECT_NAME = getenv("PROJECT_NAME", "𝙑𝙞𝙧𝙩𝙪𝙖𝙡")
OWNER = getenv("OWNER", "@kenkanasw")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/MrRih/Musikanskuy")
